...
parser.add_argument("--train_path", type=str, default="./data/test2.json",help="train file")
parser.add_argument("--test_path", type=str, default="./data/test2.json",help="test file")
