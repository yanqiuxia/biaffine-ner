...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        one_data = {
            ...
            "span_mask": torch.tensor(item['span_mask']).float()
        }
        return one_data

def yield_data(file_path,args):
    tmp = MyDataset(data_pre(file_path,args))
